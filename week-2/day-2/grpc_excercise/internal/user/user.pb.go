...
var file_pb_user_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x34, 0x0a, 0x0e, 0x41, 0x64, 0x64, 0x55, 0x73, 0x65, 0x72,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xe4, 0x01, 0x0a, 0x0b, 0x55, 0x73,
	0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2b, 0x0a, 0x07, 0x41, 0x64, 0x64,
	...
	0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x12, 0x36, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	...
	0x42, 0x0f, 0x5a, 0x0d, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x75, 0x73, 0x65,
...
var file_pb_user_proto_depIdxs = []int32{
	0, // 0: user.GetUserResponse.users:type_name -> user.User
	3, // 1: user.UserService.AddUser:input_type -> user.AddUserRequest
	2, // 2: user.UserService.GetUser:input_type -> user.GetUserRequest
	5, // 3: user.UserService.DeleteUser:input_type -> user.DeleteUserRequest
	4, // 4: user.UserService.UpdateUser:input_type -> user.UpdateUserRequest
	0, // 5: user.UserService.AddUser:output_type -> user.User
